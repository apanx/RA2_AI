...
class Omnidummy(AI.SuperAI):
    "Omnidummy strategy"
    name = "Omnidummy"
    # This is a newer version with the ability to select tactics.  Simply put 'tactic':"Ram" (or "Charge") in Bindings to make the AI use rammer/pusher tactics.  No more need for OmnidummyRam.py or any of those!
